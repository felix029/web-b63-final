	...
	class EquipeAction extends CommonAction {
		...
		protected function executeAction() {
			...
			if(isset($_POST["getbio"])){
				$_SESSION["bio"] = UserDAO::getBio($_POST["getbio"]);
				unset($_POST["getbio"]);
			}

			if(isset($_POST["newfullname"]) && isset($_POST["newjob"]) && isset($_POST["newbio"]) && !empty($_FILES["newphoto"])){
				try{
